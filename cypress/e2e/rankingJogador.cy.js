...
describe('Visualização do ranking de jogadores', () => {
    ...
    it('Cenario 1: Visualização do ranking de melhores jogadores', () => {
        cy.signinJogador();
        cy.loginJogador();
    ...
    it('Cenario 2: Ranking sem nenhuma partida finalizada', () => {
        cy.signinJogador();
        cy.loginJogador();
        cy.get(':nth-child(3) > a').click();
        cy.signinJogador2();
