...
describe('Visualização da tabela como jogador', () => {
    ...
    it('Cenario 1: Visualização da tabela com partida finalizada', () => {
        cy.signinJogador();
        cy.loginJogador();
    ...
    it('Cenario 2: Visualização quando nenhuma partida foi concluida', () => {
        cy.signinJogador();
        cy.loginJogador();
        cy.get(':nth-child(3) > a').click();
        cy.signinJogador2();
